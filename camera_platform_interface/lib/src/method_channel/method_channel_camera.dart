  ...
  Future<int> createCamera(
    ...
    bool enableAudio = false,
      ...
      createCameraWithSettings(
          cameraDescription, MediaSettings(resolutionPreset: resolutionPreset, enableAudio: enableAudio));
  ...
  Future<int> createCameraWithSettings(
    ...
    try {
      ...
      final Map<String, dynamic>? reply =
        ...
        'resolutionPreset':
            resolutionPreset != null ? _serializeResolutionPreset(mediaSettings.resolutionPreset!) : null,
    ...
    switch (call.method) {
      case 'orientation_changed':
        ...
        deviceEventStreamController.add(
            DeviceOrientationChangedEvent(deserializeDeviceOrientation(arguments['orientation']! as String)));
      default:
