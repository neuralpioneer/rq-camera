...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Future<void> _initializeWithDescription(CameraDescription description) async {
    ...
    try {
      ...
      _unawaited(
          CameraPlatform.instance.onCameraInitialized(_cameraId).first.then((CameraInitializedEvent event) {
      ...
      value = value.copyWith(
        ...
        exposureMode:
            await initializeCompleter.future.then((CameraInitializedEvent event) => event.exposureMode),
  ...
  Future<void> resumePreview() async {
    ...
    try {
      ...
      value = value.copyWith(
          isPreviewPaused: false, previewPauseOrientation: const Optional<DeviceOrientation>.absent());
    } on PlatformException catch (e) {
      throw CameraException(e.code, e.message);
    }
  }
  ...
  Future<void> startVideoRecording({
    ...
    try {
      await CameraPlatform.instance
          .startVideoCapturing(VideoCaptureOptions(_cameraId, streamCallback: streamCallback),extensionName: extensionName);
      value = value.copyWith(
